...
export const Tile: FunctionComponent<PropsWithChildren<TileProps>> = ({
    ...
    return (
        <div
            className="relative overflow-hidden bg-(--card-bg) border border-(--card-border) rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 ease-out p-6 md:p-8 group backdrop-blur-sm"
            data-testid={testId}
        >
