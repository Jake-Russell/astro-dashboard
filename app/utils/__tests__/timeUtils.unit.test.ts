...
describe("timeUtils", () => {
    ...
    describe("isCurrentlyPrime", () => {
        ...
        it("should return true, given time is between primeTimeStart and primeTimeEnd", () => {
            ...
            expect(isCurrentlyPrime(primeTimeStartEpoch, primeTimeEndEpoch, lat, lon)).toBe(true);
        });

        it("should return false, given time is before primeTimeStart", () => {
            expect(isCurrentlyPrime(primeTimeStartEpoch, primeTimeEndEpoch, lat, lon)).toBe(false);
        });
        ...
        it("should return false, given primeTimeStartEpoch is 0", () => {
            expect(isCurrentlyPrime(0, primeTimeEndEpoch, lat, lon)).toBe(false);
        });

        it("should return false, given primeTimeEndEpoch is 0", () => {
            expect(isCurrentlyPrime(primeTimeStartEpoch, 0, lat, lon)).toBe(false);
        });
    });
